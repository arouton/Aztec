...
///
////////////////////////////////////////////////////////////
inline CQuaternion::CQuaternion(const azMatrix4x4& Matrix)
{
    FromMatrix(Matrix);
}
...
///
////////////////////////////////////////////////////////////
inline azMatrix4x4 CQuaternion::ToMatrix() const
{
    float xx = x * x;
    float xy = x * y;
    float xz = x * z;
    ...
    return azMatrix4x4(1 - 2 * (yy + zz),     2 * (xy - zw),     2 * (xy + yw), 0,
...
///
////////////////////////////////////////////////////////////
inline void CQuaternion::FromMatrix(const azMatrix4x4& Matrix)
{
